...
import de.hybris.practice.storefront.forms.EmailFileAttachmentForm;
...
public class HomePageController extends AbstractPageController
{
	...
	{
		model.addAttribute(PracticeCoreConstants.EMAIL_FILE_ATTACHMENT_FORM, new EmailFileAttachmentForm());
		if (logout)
		{
	...
	@RequestMapping(value = "/attachEmail", method = RequestMethod.POST)
	public String sendEmailattach(final EmailFileAttachmentForm emailFileAttachmentForm, final Model model)
	{
		System.out.println("email is being generated at this stage of this process.............................");
		customerFacade.sendEmailWithAttachment(emailFileAttachmentForm.getFile());
