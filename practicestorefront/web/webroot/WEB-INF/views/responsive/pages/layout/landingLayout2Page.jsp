...
<form:form method = "POST" modelAttribute = "emailAttachmentForm" action="/practicestorefront/electronics/en/sendEmail"
          accept="text/csv">
       
         Please select a file to upload : 
         <input type = "file" name = "file" />
         <input id="email" type = "submit" value = "upload" />
...
<c:url value="/sendEmail?CSRFToken=${CSRFToken}" var="attachemntURL"/>
         
      </form:form>--%>

<spring:url value="/attachEmail" var="attachemntURL" htmlEscape="false">
                <spring:param name="CSRFToken" value="${CSRFToken.token}"/>
            </spring:url>
<form:form method = "POST" modelAttribute = "emailFileAttachmentForm" action="${attachemntURL}" enctype="multipart/form-data">
       
         Please select a file to upload ${CSRFToken.token}: 
         <input type = "file" name = "file" />
