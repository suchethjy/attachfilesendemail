...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/practicestorefront/electronics/en",
						"https://electronics.local:9002/practicestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/practicestorefront/electronics/en",
						"https://electronics.local:9002/practicestorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/practicestorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/practicestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/practicestorefront/electronics/en",
						"https://electronics.local:9002/practicestorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/practicestorefront",
						"https://electronics.local:9002/practicestorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/practicestorefront",
						"https://electronics.local:9002/practicestorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/practicestorefront/electronics/en",
						"https://electronics.local:9002/practicestorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
